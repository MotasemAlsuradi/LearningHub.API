...
namespace LearningHub.Infra.Repository
{
    public class CourseRepository: ICourseRepository
    {
        ...
        {
            IEnumerable<Course> records = _dbContext.Connection.Query<Course>("Course_pkg.GetAllCourses", commandType: CommandType.StoredProcedure);
        ...
        public void CreateCourse(Course course)
        {
            ...
            var record = _dbContext.Connection.Execute("Course_pkg.CreateCourse", parameter, commandType: CommandType.StoredProcedure);
        }
